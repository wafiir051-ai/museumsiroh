  ...
  return (
    <div className="space-y-8">
      ...
      <div className="card p-6">
        <p className="text-sm font-medium text-siroh-ink/70">Kode Rujukanmu</p>
        <p className="mt-1 font-mono text-2xl font-semibold text-siroh-gold">{refCode}</p>

        <div className="mt-5 flex items-center gap-2 rounded-xl border border-siroh-green/15 bg-siroh-green/5 p-3">
          <code className="flex-1 truncate text-sm">{baseLink}</code>
          <button
      ...
      <div className="grid gap-5 lg:grid-cols-2">
        <div className="card p-6">
          ...
          <p className="mt-1 text-sm text-siroh-ink/55">
          ...
          <div className="mt-4 space-y-3">
            {channels.map((ch) => (
              <div
                key={ch.key}
                className="flex items-center justify-between rounded-xl border border-siroh-green/10 p-3"
              >
        ...
        <div className="card flex flex-col items-center p-6 text-center">
          ...
          <div className="mt-5 rounded-2xl border border-siroh-gold/30 bg-white p-4">
            <QRCodeCanvas
              id="siroh-qr-canvas"
